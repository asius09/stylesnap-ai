      ...
      >
        <header>
          ...
          <p className="mb-6 text-base text-gray-300">
            ...
            <span lang="en" aria-label="Terms">
              &quot;Terms&quot;
            </span>
            ,{" "}
            <span lang="en" aria-label="Terms and Conditions">
              &quot;Terms and Conditions&quot;
            </span>
            ) carefully before using the StyleSnap AI website (the{" "}
            <span lang="en" aria-label="Service">
              &quot;Service&quot;
            </span>
            ,{" "}
            <span lang="en" aria-label="Site">
              &quot;Site&quot;
            </span>
        ...
        <section className="mb-6" aria-labelledby="use-of-service-heading">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              The Service allows you to upload images and generate AI-styled
              artwork for personal, non-commercial use only.
            </li>
            <li>
            ...
            <li>
              ...
              abusive purposes, including but not limited to uploading illegal,
              offensive, or copyrighted material without permission.
            </li>
            <li>
              We reserve the right to refuse service, remove content, or
              terminate access at our sole discretion, without notice or
              liability.
            </li>
          </ul>
        </section>
        ...
        >
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              All content, features, and functionality on this Site (excluding
              user-uploaded images) are the exclusive property of StyleSnap AI
              and its licensors.
            </li>
            <li>
              You retain ownership of images you upload. Generated artwork is
              provided for your personal use; you are responsible for ensuring
              you have the rights to use and upload any content.
            </li>
            <li>
              You may not use the Service or any generated content for
              commercial purposes, redistribution, or resale without explicit
              written permission.
            </li>
          </ul>
        </section>
        <section className="mb-6" aria-labelledby="disclaimer-heading">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              ...
              <span lang="en" aria-label="as is">
                &quot;AS IS&quot;
              </span>{" "}
              and{" "}
              <span lang="en" aria-label="as available">
                &quot;AS AVAILABLE&quot;
              </span>{" "}
              basis. We make no warranties, express or implied, regarding the
              Service&apos;s accuracy, reliability, or availability.
            </li>
            <li>
            ...
            <li>
              ...
              any loss, damage, or harm resulting from your use of the Service
        ...
        >
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              To the fullest extent permitted by law, StyleSnap AI and its
              affiliates, partners, or licensors shall not be liable for any
              direct, indirect, incidental, special, consequential, or punitive
              damages arising from or related to your use of the Service.
            </li>
            <li>
              We are not liable for any content uploaded by users or for any
              third-party claims related to your use of the Service.
            </li>
            <li>
              You agree to indemnify and hold harmless StyleSnap AI from any
        ...
        <section className="mb-6" aria-labelledby="governing-law-heading">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              ...
              laws of the jurisdiction in which the Service operates, without
              regard to its conflict of law provisions.
            </li>
            <li>
              Any disputes arising from these Terms or your use of the Service
              shall be resolved exclusively in the courts of the applicable
              jurisdiction.
            </li>
          </ul>
        </section>
