    ...
    <div className="flex flex-col items-center justify-center">
      ...
      >
        ...
        <button
          ...
          onClick={onRemove}
          className="absolute top-2 right-2 z-30 flex h-8 w-8 items-center justify-center rounded-full border border-white/30 bg-black/60 shadow-lg backdrop-blur-md transition-colors duration-150 focus:outline-none cursor-pointer hover:bg-red-600 hover:text-white focus:bg-red-600 focus:text-white focus:ring-2 focus:ring-red-500 focus:ring-offset-2 active:text-white disabled:cursor-not-allowed disabled:opacity-60"
          tabIndex={0}
